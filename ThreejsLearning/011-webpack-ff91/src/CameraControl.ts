...
class CamControl {
    forceUpdate: boolean;
    options: { distance: number; focusPos: any; rotation: any; rotRange: { xMax: number; xMin: number; yMax: number; yMin: number; }; distRange: { max: number; min: number; }; fov: number; eyeSeparation: number; smartUpdates: boolean; };
    vpW: number;
    vpH: number;
    quatX: any;
    quatY: any;
    ...
    CamControl.prototype.readOptions = function (_options:any) {
    ...
    CamControl.prototype.setDistance = function (dist:any) {
    ...
    CamControl.prototype.setDistRange = function (max:any, min:any) {
      this.options.distRange.max = max;
      this.options.distRange.min = min;
    };
    CamControl.prototype.setRotation = function (_rotX:any, _rotY:any, _rotZ:any) {
      if (_rotX === void 0) {
        _rotX = 0;
      }
      if (_rotY === void 0) {
