...
// const THREE:any = (window as any).THREE
   ...
   */
  export default abstract class Item extends THREE.Mesh {
    /** */
    private scene: Scene;
    /** */
    ...
    /** */
    protected halfSize = new THREE.Vector3
     ...
     * @param scale TODO 
     */
    constructor(protected model: Model, public metadata: Metadata, geometry: THREE.Geometry, material: THREE.Material, position: any, rotation: number, scale: any) {
      super();
    ...
    public updateHighlight() {
      ...
      (<any>this.material).materials.forEach((material:any) => {
    ...
    /** */
    public createGlow(color: any, opacity:any, ignoreDepth:any): THREE.Mesh {
