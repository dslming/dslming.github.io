...
import {Metadata} from './metadata'
   ...
   */
  export default abstract class FloorItem extends Item {
    constructor(model: Model, metadata: Metadata, geometry: THREE.Geometry, material: any, position: THREE.Vector3, rotation: number, scale: THREE.Vector3) {
