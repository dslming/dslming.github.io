...
export default {
  ...
  components: {
    ...
    Playlist,
    SongLoading,
    universe: resolve => {require(['3d/001-universe/universe'], resolve)},
    wind: resolve => {require(['3d/002-wind/wind'], resolve)},
    light: resolve => {require(['3d/003-light/light'], resolve)},
    cat: resolve => {require(['3d/004-cat/cat'], resolve)},
    particles: resolve => {require(['3d/005-particles/particles'], resolve)},
    wave: resolve => {require(['3d/006-wave/wave'], resolve)},
    shader: resolve => {require(['3d/007-shader/shader'], resolve)},
    smiley: resolve => {require(['3d/008-smiley/smiley'], resolve)},
  }
}
</script>
